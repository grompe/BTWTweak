...
{
  tweak("FCBlockBlockDispenser", null, BOTH, "DispenseBlockOrItem(Laab;IIILjava/util/Random;)V", [0xB78B99F2, 0x9DEF97A1], "Handling loose rocks",
  function(mn)
  {
    var label;
    var boundary = null;
...
{
  tweak("rh", "EntityItem", BOTH, "l_()V", 0x73675C9C, "Boosting item stay delay",
  function(mn)
  {
