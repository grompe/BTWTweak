...
function(cn)
{
  ...
  mn.instructions.add(toInsnList(
    [
      ...
      VarInsnNode(ILOAD, 2),
      VarInsnNode(ILOAD, 4),
      JumpInsnNode(IFNE, l12),
      VarInsnNode(ILOAD, 3),
      JumpInsnNode(IFEQ, l12),
      IntInsnNode(BIPUSH, 16),
      ...
      VarInsnNode(ILOAD, 4),
      JumpInsnNode(IFEQ, l14),
      InsnNode(ICONST_0),
      JumpInsnNode(GOTO, l15),
      l14,
      FrameNode(F_FULL, 10, ["aww", INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, "apa"], 4, ["aww", INTEGER, INTEGER, INTEGER]),
      ...
      InsnNode(ICONST_2),
      JumpInsnNode(IF_ICMPLE, l17),
      InsnNode(ICONST_1),
      JumpInsnNode(GOTO, l18),
      l17,
      ...
      InsnNode(DCMPG),
      JumpInsnNode(IFGE, l24),
      InsnNode(ICONST_1),
      JumpInsnNode(GOTO, l25),
      l24,
      ...
      VarInsnNode(ALOAD, 4),
      JumpInsnNode(IFNULL, l29),
      VarInsnNode(ALOAD, 4),
      FieldInsnNode(GETFIELD, "ara", "a", "Larb;"),
      FieldInsnNode(GETSTATIC, "arb", "a", "Larb;"),
      JumpInsnNode(IF_ACMPNE, l29),
      VarInsnNode(ALOAD, 0),
      VarInsnNode(ALOAD, 4),
      FieldInsnNode(GETFIELD, "ara", "b", "I"),
      VarInsnNode(ALOAD, 4),
